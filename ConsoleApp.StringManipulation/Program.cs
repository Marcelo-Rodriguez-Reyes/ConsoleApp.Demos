...
//Use a const string to prevent modification to string
...
/* String manipulation methods and properties. Sometimes is just an assessment */

//Null or empty checks
//find the length of a string

Console.WriteLine($"{nameof(s1)} has the length of {s1.Length}");
Console.WriteLine($"{nameof(s6)} has the length of {s6.Length}");
//Console.WriteLine($"{nameof(s4)} has the length of {s4.Length}"); //Will cause null exception
