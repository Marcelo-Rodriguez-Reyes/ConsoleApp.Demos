...
/*
 * Objects can be initialized like this alternatively, where the object's properties are all set at once.
   Person baby = new Person
   {
        LastName = "Thompson",
        FirstName = "Theresa",
...
Console.WriteLine($"{nameof(Sphere)} volume is: {cuboidVolume}");
